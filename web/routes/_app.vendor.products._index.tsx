...
export default function VendorProductsIndex({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Products"
        description={`Viewing ${number.format(stats.total)} catalog items relevant to vendor operations.`}
      />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Items available for production and fulfillment.</CardDescription>
        </CardHeader>
        <CardContent>
          <AutoTable
            model={api.product}
