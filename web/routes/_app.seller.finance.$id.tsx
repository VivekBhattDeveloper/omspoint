...
import { api } from "../api";
import type { Route } from "./+types/_app.seller.finance.$id";
...
export default function SellerPaymentDetail({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Confirm settlement details and sync with finance team."
        actions={
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>Payout timing</CardDescription>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>• Confirm marketplace remittance received.</p>
            <p>• Notify finance if discrepancy detected.</p>
            <p>• Push payout summary to sellers.</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <AutoForm
            ...
            findBy={payment.id}
            onSuccess={() => navigate("/seller/finance")}
          >
            <SubmitResultBanner />
